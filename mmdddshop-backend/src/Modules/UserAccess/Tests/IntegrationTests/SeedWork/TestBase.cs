...
namespace ModularMonolithDDD.Modules.UserAccess.Tests.IntegrationTests.SeedWork
{
    public class TestBase
    {
        ...
        protected IEmailSender EmailSender { get; private set; } = default!;

        protected ExecutionContextMock ExecutionContext { get; private set; } = default!;

        protected IEventsBus EventsBus { get; private set; } = default!;
        ...
        public async Task BeforeEachTest()
        {
            ...
            {
                throw new ApplicationException("Define connection string to integration tests database");
            }
