...
{
using Dapper;
using ModularMonolithDDD.BuildingBlocks.Application.Data;
...
using Microsoft.IdentityModel.Tokens;
    ...
    public sealed class CustomApplicationStore : IOpenIddictApplicationStore<CustomApplication>
    {
        ...
        /// <summary>
        /// Gets the permissions granted to this application (not implemented - returns empty).
        /// </summary>
        public ValueTask<ImmutableArray<string>> GetPermissionsAsync(CustomApplication application, CancellationToken cancellationToken) => new(ImmutableArray<string>.Empty);
        
        /// <summary>
        /// Gets post-logout redirect URIs (not implemented - returns empty).
        /// </summary>
        public ValueTask<ImmutableArray<string>> GetPostLogoutRedirectUrisAsync(CustomApplication application, CancellationToken cancellationToken) => new(ImmutableArray<string>.Empty);
        ...
        /// <summary>
        /// Gets redirect URIs for authorization code flow (not implemented - returns empty).
        /// </summary>
        public ValueTask<ImmutableArray<string>> GetRedirectUrisAsync(CustomApplication application, CancellationToken cancellationToken) => new(ImmutableArray<string>.Empty);
    ...
    public sealed class CustomAuthorizationStore : IOpenIddictAuthorizationStore<CustomAuthorization>
    {
        ...
        public ValueTask SetApplicationIdAsync(CustomAuthorization authorization, string? identifier, CancellationToken cancellationToken) => ValueTask.CompletedTask;
        public ValueTask SetCreationDateAsync(CustomAuthorization authorization, DateTimeOffset? date, CancellationToken cancellationToken) => ValueTask.CompletedTask;
        public ValueTask SetPropertiesAsync(CustomAuthorization authorization, ImmutableDictionary<string, JsonElement> properties, CancellationToken cancellationToken) => ValueTask.CompletedTask;
        public ValueTask SetScopesAsync(CustomAuthorization authorization, ImmutableArray<string> scopes, CancellationToken cancellationToken) => ValueTask.CompletedTask;
        public ValueTask SetStatusAsync(CustomAuthorization authorization, string? status, CancellationToken cancellationToken) => ValueTask.CompletedTask;
        public ValueTask SetSubjectAsync(CustomAuthorization authorization, string? subject, CancellationToken cancellationToken) => ValueTask.CompletedTask;
        public ValueTask SetTypeAsync(CustomAuthorization authorization, string? type, CancellationToken cancellationToken) => ValueTask.CompletedTask;
    ...
    public sealed class CustomTokenStore : IOpenIddictTokenStore<CustomToken>
    {
        ...
        {
            using var connection = _connectionFactory.GetOpenConnection();
            await connection.ExecuteAsync(Sql.InsertToken, token);
        }
        ...
        public ValueTask SetApplicationIdAsync(CustomToken token, string? identifier, CancellationToken cancellationToken) => ValueTask.CompletedTask;
        public ValueTask SetAuthorizationIdAsync(CustomToken token, string? identifier, CancellationToken cancellationToken) => ValueTask.CompletedTask;
        public ValueTask SetCreationDateAsync(CustomToken token, DateTimeOffset? date, CancellationToken cancellationToken) => ValueTask.CompletedTask;
        public ValueTask SetExpirationDateAsync(CustomToken token, DateTimeOffset? date, CancellationToken cancellationToken) => ValueTask.CompletedTask;
        public ValueTask SetPayloadAsync(CustomToken token, string? payload, CancellationToken cancellationToken) => ValueTask.CompletedTask;
        public ValueTask SetPropertiesAsync(CustomToken token, ImmutableDictionary<string, JsonElement> properties, CancellationToken cancellationToken) => ValueTask.CompletedTask;
        public ValueTask SetRedemptionDateAsync(CustomToken token, DateTimeOffset? date, CancellationToken cancellationToken) => ValueTask.CompletedTask;
        public ValueTask SetReferenceIdAsync(CustomToken token, string? identifier, CancellationToken cancellationToken) => ValueTask.CompletedTask;
        public ValueTask SetStatusAsync(CustomToken token, string? status, CancellationToken cancellationToken) => ValueTask.CompletedTask;
        public ValueTask SetSubjectAsync(CustomToken token, string? subject, CancellationToken cancellationToken) => ValueTask.CompletedTask;
        public ValueTask SetTypeAsync(CustomToken token, string? type, CancellationToken cancellationToken) => ValueTask.CompletedTask;
