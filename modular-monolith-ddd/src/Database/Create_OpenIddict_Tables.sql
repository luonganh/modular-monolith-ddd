...
-- NOTE: Removed SQL Server batch separators (GO) and USE statement for Liquibase compatibility.
-- Liquibase executes statements via JDBC; 'GO' is a client-side batch separator not understood by SQL Server.
-- The connection already targets the correct database; do not switch context here.
...
BEGIN
    ...
    (
        ...
        ResourcesJson NVARCHAR(1000) NULL,
    ...
    BEGIN
        ...
        (
            ...
            ScopesJson NVARCHAR(1000) NULL,
            Properties NVARCHAR(1000) NULL,
...
BEGIN
    ...
    (
        ...
        -- Payload/Primitives
        Payload NVARCHAR(4000) NULL,           -- serialized payload if you need to store it
        Properties NVARCHAR(1000) NULL,        -- optional JSON metadata
