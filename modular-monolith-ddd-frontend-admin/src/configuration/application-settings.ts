...
export class ApplicationSettings {
    ...
    private static readonly DEFAULT_AUTHORITY = 'http://localhost:8082/realms/modular-monolith-ddd';
    ...
    private static readonly DEFAULT_SCOPE = 'openid profile offline_access';
